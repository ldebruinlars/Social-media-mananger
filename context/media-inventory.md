# Media-inventaris ACA

Laatste scan: 14 september 2026 via de Google Drive connector (account l.debruin@allcourtacademy.com), Canva en Higgsfield.

## Google Drive: gevonden

| Bestand | Type | Grootte | Eigenaar | Bruikbaar voor |
|---|---|---|---|---|
| ACA_PoortPadel_29mei-6.jpg | foto | 9 MB | susan@pittigbakkie.nl (gedeeld) | feed, carrousel, cover |
| ACA_PoortPadel_29mei-32.jpg | foto | 4 MB | susan@pittigbakkie.nl (gedeeld) | feed, story |
| APA 13 mei-20.jpg | foto | 5 MB | susan@pittigbakkie.nl (gedeeld) | feed |
| Gemini_Generated_Image_3m6kof3m6kof3m6k.png | AI beeld | 8 MB | susan@pittigbakkie.nl | alleen als achtergrond |
| Interview_Pablo_final.mp4 | video | 89 MB | Lars (map "Saved from Chrome") | Reels knippen: 3 tot 5 clips van 15 tot 45 sec |
| lars_de_bruin_email_banner_2x (2/3/4).png | banner | klein | Lars | e-mail, niet social |
...
**Actie voor Lars**: maak in Drive de map `ACA Social Media` met submappen `01 Inbox` (alles ruw erin), `02 Klaar` en `03 Gepubliceerd`. Deel de volledige fotoserie van 29 mei en 13 mei van Susan erin. Zet alle telefoonvideo's van lessen en kids camps in `01 Inbox`. Daarna scan ik opnieuw en bouw ik de contentkalender op wat er echt is.

## Canva: gevonden

| Design | Id | Gebruik |
|---|---|---|
| Padel Kids Camp 2026 shirt voorkant en achterkant (5 varianten) | DAHQqgUiNwo, DAHQr8jycwM, DAHQruvpJg4, DAHQruWD_M4, DAHQ8b1w9eg | logo's ACA en Poort Padel, kids camp visuals |
| Website ideas/AllCourtAcademy (11 pagina's) | DAHG74knt4c | brandkleuren, alle websiteteksten over lessen |
| Retro Padel Camp illustraties met mascotte (3) | DAHQqulXZ0c, DAHQ8ea2ti0, DAHQqokMjws | kids content, stickers |
| Children's Padel Camp Graphic | DAHQqj1LTB8 | kids camp feed post |
...
- **Higgsfield** (verbonden): AI-beeld en video, TikTok publiceren mogelijk maar er is nog geen TikTok account gekoppeld.
