...
SPECS=[
 ...
 dict(id='07_laatste_plekken',photo=D2+'ACA_PoortPadel_29mei-40.jpg',focus=(0.5,0.3),kicker='NOG 2 WEKEN · START 19 OKTOBER',head=['LAATSTE PLEKKEN','NAJAARSREEKS'],sub='8 lessen van 1 uur, vaste coach, vervanger toegestaan',cta='SCHRIJF JE IN',hsize=76),
 ...
 dict(id='10_competitie',photo=D2+'ACA_PoortPadel_29mei-29.jpg',focus=(0.42,0.28),kicker='KNLTB COMPETITIE · START NOVEMBER',head=['KLAAR VOOR','DE COMPETITIE?'],sub='Wedstrijdtraining: tactiek, spelinzicht, druk zetten aan het net',cta='BOEK WEDSTRIJDTRAINING'),
...
os.makedirs('posters/out6',exist_ok=True)
for s in SPECS:
    make(s).save(f"posters/out6/{s['id']}.jpg",quality=92)
ims=[Image.open(f"posters/out6/{s['id']}.jpg") for s in SPECS]
...
sheet.save('posters/contact6.jpg',quality=82); print('ok')
