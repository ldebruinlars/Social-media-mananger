...
SPECS=[
 ...
 dict(id='10_competitie',photo=D+'543611.jpg',focus=(0.5,0.12),kicker='KNLTB COMPETITIE · START NOVEMBER',head=['KLAAR VOOR','DE COMPETITIE?'],sub='Wedstrijdtraining: tactiek, spelinzicht, druk zetten aan het net',cta='BOEK WEDSTRIJDTRAINING'),
...
os.makedirs('posters/out7',exist_ok=True)
for s in SPECS:
    make(s).save(f"posters/out7/{s['id']}.jpg",quality=92)
ims=[Image.open(f"posters/out7/{s['id']}.jpg") for s in SPECS]
...
sheet.save('posters/contact7.jpg',quality=82); print('ok')
